...
// SSID & Password
const char* ssid = "212-1";
const char* password = "ntuedorm";
    ...
    <head>\
      <style>\
        body{ display: flex; flex-direction: column;}\
         input {display: block; background: #fff6f6;color:#e597a7;} \
        a { background: #fff6f6;color:#e597a7; width: 200px; height: 50px; margin: 20px; font-size: 30pt; text-decoration: none;}\
      </style>\
    </head>\
    <body>\
